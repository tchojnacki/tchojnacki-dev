...
import Math from "@post/Math.astro"
import Sources from "@post/Sources.astro"
import JsdocSwitch from "@post/neural-networks/jsdoc/JsdocSwitch"
import JsdocSyntax from "@post/neural-networks/jsdoc/JsdocSyntax.astro"
import SimpleScalarExample from "@post/neural-networks/examples/SimpleScalarExample"
import RationalExprExample from "@post/neural-networks/examples/RationalExprExample"
import LinearExample from "@post/neural-networks/examples/LinearExample"
import LinearFigure from "@post/neural-networks/examples/LinearFigure.astro"
import NeuronDiagram from "@post/neural-networks/NeuronDiagram.astro"
import Experiment from "@post/neural-networks/experiment/Experiment"
...
<JsdocSyntax>
<Code slot="typed" lang="javascript" code={`
  class Scalar {
    /** @type {number} */
    value;
...
`} />
<Code slot="untyped" lang="javascript" code={`
  class Scalar {
    value;
...
<JsdocSyntax>
<Code slot="typed" lang="javascript" ins={{ range: "9-12" }} code={`
  class Scalar {
    /**
      * @param {Scalar} other
      * @returns {Scalar}
...
`} />
<Code slot="untyped" lang="javascript" ins={{ range: "5-8" }} code={`
  class Scalar {
    add(other) {
      const out = new Scalar(this.value + other.value);
      out.#children = [this, other];
