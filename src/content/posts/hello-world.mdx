...
I've been gathering many drafts of blog posts on the side in the meantime, so you might expect
...
tooling. However, the blog might branch out to other topics in the future.
...
The source code is compiled to static HTML. Content collections, like blogs or projects, are
